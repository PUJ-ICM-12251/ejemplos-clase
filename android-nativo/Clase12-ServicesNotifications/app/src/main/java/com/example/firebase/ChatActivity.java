...
import com.example.firebase.services.BasicJobIntentServiceChat;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        loadMessages();
        Intent intent = new Intent(ChatActivity.this, BasicJobIntentServiceChat.class);
        intent.putExtra("milliSeconds", 5000);
        BasicJobIntentServiceChat.enqueueWork(ChatActivity.this, intent);
